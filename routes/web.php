...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('forum')->name('forum.')->group(function () {
        ...
        // Posts 
        Route::post('/threads/{thread}/posts', [ForumPostController::class, 'store'])->name('posts.store'); // Thêm bài viết vào thread
        ...
        // Replies 
        Route::post('/posts/{post}/replies', [ForumReplyController::class, 'store'])->name('replies.store'); // Thêm reply vào post
    ...
    // Route::get('/threads/{thread}/suggestions', [ForumThreadController::class, 'getSuggestions'])->name('threads.suggestions'); 
    // Route::get('/trending-topics', [ForumThreadController::class, 'getTrendingTopics'])->name('trending.topics'); 
