...
<div class="container mx-auto p-4">
    <h1 class="text-3xl font-bold mb-4 text-gray-800">Chỉnh Sửa Thể Loại</h1>
    ...
    <form action="{{ route('categories.update', $category) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <button type="submit" class="bg-blue-500 text-white px-6 py-3 rounded-md hover:bg-blue-600 transition duration-300">Cập Nhật</button>
    </form>
</div>
@endsection
