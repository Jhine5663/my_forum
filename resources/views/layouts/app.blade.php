...
<head>
    ...
    <style>
        ...
        .active-nav-link::after {
            ...
            background-color: #3b82f6; animation: pulse 2s infinite;
        }
        ...
        .pixel-border { border: 4px solid #3b82f6; box-shadow: 8px 8px 0 rgba(30, 58, 138, 0.5); }
        ...
        .retro-bg {
            background: repeating-linear-gradient(
                0deg, #1e293b, #1e293b 2px, #1e1b4b 2px, #1e1b4b 4px
            );
        }
    </style>
</head>
<body class="min-h-screen flex flex-col">
    ...
    <div class="md:hidden bg-gray-800 px-4 py-2 border-b border-blue-500/20">
        <div class="relative">
            <input type="text" placeholder="Search games..." class="w-full py-2 px-4 rounded-full bg-gray-700 text-white focus:outline-none border border-blue-500/30">
