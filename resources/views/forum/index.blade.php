            ...
            <div class="md:w-1/2 mb-6 md:mb-0">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('register') }}" 
                       class="btn-pixel bg-white text-blue-800 hover:bg-gray-200 px-6 py-2 font-medium"> 
                        Tham gia ngay
                    </a>
                    <a href="{{ route('forum.threads.index') }}" 
                       class="btn-pixel bg-transparent border-white text-white hover:bg-white hover:text-blue-800 px-6 py-2 font-medium"> 
                        Tìm hiểu thêm
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6 flex justify-between items-center">
        ...
        @auth
            <button onclick="window.location.href='{{ route('forum.threads.create') }}'" 
                    class="btn-pixel bg-blue-500 hover text-white px-4 py-2 rounded-full ml-2">
            ...
            @foreach ($categories as $category)
                <div class="bg-white p-6 shadow-xl rounded-lg border border-blue-200 game-card">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <a href="{{ route('forum.categories.show', $category) }}" 
                           class="btn-pixel bg-gray-100 px-3 py-1 text-sm border-gray-300 hover:bg-gray-200 text-gray-700"> 
