...
@section('admin-content')
    <h1 class="text-2xl font-bold pixel-font text-blue-700 glow-text mb-4">Tạo chủ đề</h1>
    <div class="bg-white-800 p-6 rounded-lg shadow-md border border-blue-500/20">
        <form action="{{ route('admin.threads.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="category_id" class="block text-gray-600 font-bold mb-2">Danh mục</label>
                <select name="category_id" id="category_id" class="w-full py-2 px-3 rounded bg-w-700 text-black focus:outline-none focus:ring-2 focus:ring-blue-500 border border-blue-500/30" required>
