...
@section('admin-content')
    ...
    <div class="mb-4">
        <a href="{{ route('categories.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 rounded pixel-btn">Tạo danh mục</a>
    </div>
                ...
                <tbody>
                    @foreach($categories as $category)
                        <tr class="border-b border-blue-500/20">
                            ...
                            <td class="py-2 px-4">
                                <a href="{{ route('categories.edit', $category) }}" class="text-blue-400 hover:underline">Sửa</a>
